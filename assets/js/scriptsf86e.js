...
NioApp = function(w, k, o, d) {
    ...
    w.Util.classInit = function() {
        ...
        !0 === w.getStatus.isTouch ? r.addClass("has-touch") : r.addClass("no-touch"),
        a(),
        "rtl" === r.attr("dir") && (r.addClass("has-rtl"),
        w.getStatus.isRTL = !0),
        r.addClass("nk-" + l),
        k(o).on("resize", a)
    }
    ...
    w.Util.preLoader = function() {
        var a = k(".preloader")
          , l = k(".spinner");
        a.exists() && (r.addClass("page-loaded"),
    ...
    w.Util.imageBG = function() {
        ...
        a.exists() && a.each(function() {
            var a = k(this)
              ...
              , t = !(void 0 === e || !e) && e
              , o = !(void 0 === s || !s) && s;
            void 0 !== i && "" !== i && (l.hasClass("has-bg-image") || l.addClass("has-bg-image"),
            t ? a.hasClass("overlay-" + t) || (a.addClass("overlay"),
            a.addClass("overlay-" + t)) : a.hasClass("overlay-fall") || a.addClass("overlay-fall"),
    ...
    w.Util.toggler = function() {
        ...
        m.on("click", "body", function(a) {
            var l = k(s)
              , e = k(i);
            e.is(a.target) || 0 !== e.has(a.target).length || l.is(a.target) || 0 !== l.has(a.target).length || (e.removeClass("active"),
          ...
          , c = {
            ...
            navToggle: function() {
                l.exists() && l.on("click", function(a) {
                    ...
                    l.toggleClass(n),
                    s.exists() ? k("#" + e).slideToggle().toggleClass(d) : k("#" + e).parent().toggleClass(d),
            ...
            navClose: function() {
                ...
                a.on("click", function() {
                    k(this).hasClass("menu-toggle") || (l.removeClass(n),
                    e.removeClass(d),
                    r.removeClass("overlay-" + d))
                }),
                m.on("click", "body", function(a) {
                    !i.is(a.target) && 0 === i.has(a.target).length && !h.is(a.target) && 0 === h.has(a.target).length && P.width() < 992 && (l.removeClass(n),
            ...
            menuToggle: function() {
                i.exists() && i.on("click", function(a) {
                    var l = k(this).parent();
                    P.width() < 992 && (l.children(t).slideToggle(400),
            ...
            mobileNav: function() {
                P.width() < 992 ? e.delay(500).addClass(v) : (e.delay(500).removeClass(v),
                e.removeClass(d))
            },
            currentPage: function() {
                a.exists() && a.each(function() {
                    g === this.href && "" !== p[1] && k(this).closest("li").addClass("active").parent().closest("li").addClass("active"),
        ...
        k('a.menu-link[href*="#"]:not([href="#"])').on("click", function() {
            if (location.pathname.replace(/^\//, "") === this.pathname.replace(/^\//, "") && location.hostname === this.hostname) {
                var a = this.hash
                  ...
                  , e = a.length ? k(a) : l;
                if (e.length)
                    return k(".navbar-toggle").removeClass("active"),
                    k(".header-navbar").removeClass("menu-shown"),
                    k("html, body").delay(150).animate({
    ...
    w.Plugins.carousel = function() {
        ...
        function C(a) {
            var l = k(a);
            !l.hasClass("blank-added") && 575 < P.width() ? (l.trigger("add.owl.carousel", ['<div class="item-blank"></div>']),
            l.addClass("blank-added").removeClass("blank-removed"),
            l.trigger("refresh.owl.carousel")) : !l.hasClass("blank-removed") && P.width() < 576 && l.hasClass("blank-added") && (l.trigger("remove.owl.carousel", -1),
    ...
    w.Plugins.validform = function() {
        ...
        if (!k().validate)
            return console.log("jQuery Form Validate not Defined."),
            !0;
        a.exists() && a.each(function() {
            var a = k(this);
            a.validate(),
                ...
                submitHandler: function(e) {
                    ...
                    k(e).ajaxSubmit({
                        ...
                        success: function(a) {
                            ...
                            s.removeClass("alert-danger alert-success").addClass("alert " + l).html(a.message).slideDown(400),
    ...
    w.Plugins.parallax = function() {
        ...
        a.exists() && a.each(function() {
            var a = k(this);
            !0 === a.data("parallax") && (a.addClass("plx-bg"),
    ...
    w.Plugins.videoBG = function() {
        ...
        a.exists() && a.each(function() {
            ...
            o ? a.hasClass("overlay-" + o) || (a.addClass("overlay"),
            a.addClass("overlay-" + o)) : a.hasClass("overlay-fall") || a.addClass("overlay-fall"),
            d && a.addClass("overlay-opacity-" + d),
            n && w.Win.width < 768 && (a.addClass("cover-enabled"),
            a.append('<div class="bg-video-cover" style="background-image:url(' + n + ')"></div>')),
    ...
    w.promoPanel = function() {
        ...
        0 < s.length && s.on("click", function() {
            ...
            l.addClass("active"),
            null === a && Cookies.set("twz-offer", "true", {
                expires: 1,
                path: ""
            }),
            !1
