...
<head>
    ...
    <title>Silver Profile Page | NumeroTrade</title>
    ...
    <!-- Custom CSS -->
    <link rel="stylesheet" href="../assetsBack/css/silverProfile.css">
...
<body>
    ...
    <nav class="navbar navbar-expand-md bg-dark navbar-dark">
        ...
        <div class="collapse navbar-collapse" id="collapsibleNavbar">
            <ul class="navbar-nav ml-auto">
                <li class="nav-item">
                    <a class="nav-link <?= (basename($_SERVER['PHP_SELF']) == 'silverProfile.php')?'active':'';?>" href="bronzeProfile.php"><i class="fas fa-user-circle"></i>&nbsp; My Profile</a>
                </li>
                <li class="nav-item">
        ...
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <h2 class="modal-title text-dark text-center lead getAddress" id="copyTarget">hello</h2>
                ...
                <div class="modal-body">
                    ...
                    <div class="row">
                        <div class="col-lg-6 text-center">
                            ...
                            <p><i class="fa fa-dollar-sign"></i> 300</p>
                        </div>
                        <div class="col-lg-6 text-center">
                    ...
                    <form action="" class="mt-3">
                        <div class="form-group">
                            <label for="amtPaid" class="col-form-label-lg mb-0 pb-0">Amount To Be Withdrawn:</label>
                            <div class="input-group m-0 p-0">
                                <div class="input-group-prepend">
                                    <span class="input-group-text">$</span>
                                </div>
                                <input type="text" class="form-control" placeholder="Amount in Dollars" name="amtPaid" id="" required>
                                <div class="input-group-append">
                                    <span class="input-group-text">.00</span>
                                </div>
                            </div>
                        ...
                        <div class="form-group">
                            <label for="amtPaid" class="col-form-label-lg mb-0 pb-0">Your Wallet Address:</label>
                            <div class="input-group m-0 p-0">
                                <input type="text" class="form-control" placeholder="Your Wallet Address" name="traderwallet" id="" required>
                            </div>
                        </div>
                        <div class="form-group">
        ...
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <form action="" class="mt-3">
                        <div class="form-group">
                            <label for="passport" class="col-form-label-lg mb-0 pb-0">Upload your Passport Photograph</label>
                            <input type="file" class="form-control-file" name="passport" id="" required>
                        </div>
                        <div class="form-group">
                            <label for="natID" class="col-form-label-lg mb-0 pb-0">Upload a Photograph of your National ID</label>
                            <input type="file" class="form-control-file" name="natID" id="" required>
                        </div>
                        <div class="form-group">
                            <label for="birth" class="col-form-label-lg mb-0 pb-0">Upload a Photograph of your Birth Certificate :</label>
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <form action="" id="upGoldForm" class="mt-3">
                        ...
                        <div class="form-group">
                            <label for="interPassport" class="col-form-label-lg mb-0 pb-0">Upload a Photograph of your International Passport :</label>
                            <input type="file" class="form-control-file" name="interPassport" id="" required>
                        </div>
                        <div class="form-group">
                            <label for="utilbill" class="col-form-label-lg mb-0 pb-0">Upload a Photograph of your Utility Bill Document :</label>
                    ...
                    <div class="profile-user-box card-box bg-custom">
                        <div class="row">
                            <div class="col-sm-6">
                                ...
                                <?php if(!$cpro_pic):?>
                                        <img src="../assetsBack/img/avatar7.png" class="thumb-lg rounded-circle" width="408px">
                                    <?php else:?>
                                        <img src="<?= '../assetsBack/php/'.$cpro_pic; ?>" class="thumb-lg rounded-circle" width="408px">
                                    <?php endif;?>
                                </span>
                                <div class="media-body text-white">
                                    <h4 class="mt-1 mb-1 font-18"><?= $cname; ?></h4>
                                    <p class="font-13 text-light"><?= $coccupation; ?></p>
                                    <p class="text-light mb-0"><?= $ccountry; ?></p>
                                </div>
                            </div>
                            <div class="col-sm-6">
                                <div class="text-right">
                                    <button class="btn btn-light waves-effect" data-toggle="modal" data-target="#editProfile">Edit Profile</button>
                                </div>
                            </div>
                            <!-- <div class="col-sm-6">
                                <div class="text-left">
                                    <button class="btn btn-light waves-effect" data-toggle="modal" data-target="#editProfile">Talk to your Account Manager</button>
                                </div>
                            </div> -->
                        </div>
                    </div>
                ...
                <div class="col-xl-4">
                    ...
                    <div class="card-box">
                        ...
                        <div class="panel-body">
                            ...
                            <hr>
                            <div class="text-left">
                                <p class="text-muted font-13"><strong>Full Name :</strong> <span class="m-l-15"><?= $csurname; ?> <?= $cname; ?></span></p>
                                <p class="text-muted font-13"><strong>Mobile :</strong><span class="m-l-15"> <?= $cphone_number; ?></span></p>
                                <p class="text-muted font-13"><strong>Account ID :</strong> <span class="m-l-15"> SVR-13246<?= $cid; ?></span></p>
                                <p class="text-muted font-13"><strong>Email :</strong> <span class="m-l-15"> <?= $cemail; ?></span></p>
                                <p class="text-muted font-13"><strong>Location :</strong> <span class="m-l-15"> <?= $ccountry; ?></span></p>
                                <p class="text-muted font-13"><strong>Registered On :</strong> <span class="m-l-5"><span class="flag-icon flag-icon-us m-r-5 m-t-0" title="us"></span> <span> <?= $cjoin_date; ?></span></p>
                            </div>
                            <button class="btn btn-dark waves-effect" data-toggle="modal" data-target="#msgModal">Talk to the Account Manager</button>
                        </div>
                    </div>
                </div>
                <div class="col-xl-8">
                    <div class="row">
                        <div class="col-sm-4">
                            <div class="card-box tilebox-one"><i class="icon-layers float-right text-muted"></i>
                                <h6 class="text-muted text-uppercase mt-0">Account Type</h6>
                                <h2 class="" data-plugin="counterup">Silver</h2><span class="badge badge-custom">+11% </span>&nbsp;<span class="text-muted">Monthly Bonus</span></div>
                        </div>
                        <!-- end col -->
                        <div class="col-sm-4">
                            <div class="card-box tilebox-one"><i class="icon-paypal float-right text-muted"></i>
                                <h6 class="text-muted text-uppercase mt-0">Dollar Balance</h6>
                                <h2 class=""><span data-plugin="counterup"> <i class="fas fa-dollar-sign"></i> <?= $cdollar_bal; ?></span></h2><span class="badge badge-success">+29% </span></div>
                        </div>
                        <!-- end col -->
                        <div class="col-sm-4">
                            <div class="card-box tilebox-one"><i class="icon-rocket float-right text-muted"></i>
                                <h6 class="text-muted text-uppercase mt-0">Bitcoin Balance</h6>
                                <h2 class="" data-plugin="counterup"> <i class="fab fa-bitcoin"></i> <?= $cbtc_bal; ?></h2><span class="badge badge-custom">+89% </span></div>
                        </div>
                        <!-- end col -->
                    </div>
                    <!-- end row -->
                    <div class="card-box">
                        <h4 class="header-title mt-0 mb-3">Overview</h4>
                        <div class="">
                            <coingecko-coin-market-ticker-list-widget  coin-id="bitcoin" currency="usd" locale="en"></coingecko-coin-market-ticker-list-widget>
                        </div>
                        <h4 class="header-title mt-3">Bitcoin News</h4>
                        <div class="">
                            <coingecko-beam-widget  type="all" height="300" locale="en"></coingecko-beam-widget>
                        </div>
                    </div>
                    <div class="card-box">
                        <h4 class="header-title mb-3">Top Monthly Earners</h4>
    ...
    <div class="modal fade" id="editProfile">
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content">
                <div class="modal-header bg-info">
                    <h4 class="modal-title text-light lead"><i class="fas fa-cog"></i>&nbsp; EDIT MY PROFILE</h4>
                    <button type="button" class="close text-light" data-dismiss="modal">&times;</button>
                </div>
                <div class="modal-body">
                    <div class="card-deck">
