...
<head>
    ...
    <title>Funding Request | Admin Panel</title>
...
<body>
    <nav class="navbar navbar-expand-md bg-dark navbar-dark">
        <h4 class="text-light">Funding Request</h4>
    ...
    <div class="row justify-content-center my-2">
        <div class="col-lg-6 mt-4" id="showFundingNotify">
        </div>
    </div>
            ...
            $(document).ready(function(){
                ...
                function fetchFund(){
                    $.ajax({
                        ...
                        method: 'post',
                        data: { action:'fetchFund' },
                        success:function(response){
                            $("#showFundingNotify").html(response);
                        }
                    });
                }
                ...
                $("body").on("click", ".close", function(e){
                    ...
                    fundNotify_id = $(this).attr('id');


                    $.ajax({
                        url: 'assets/php/adminAction.php',
                        method: 'post',
                        data: { fundNotify_id: fundNotify_id },
                        success:function(response){
                            fetchFund();
                            checkFund();
                        }
                ...
                $("#updateFundsFormBtn").click(function(e){
                    if($("#updateFundsForm")[0].checkValidity()){
                        ...
                        $.ajax({
                            url: 'assets/php/adminAction.php',
                            method: 'post',
                            data: $("#updateFundsForm").serialize()+"&action=updateFunds",
                            success:function(response){
