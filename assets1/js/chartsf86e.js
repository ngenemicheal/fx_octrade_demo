                        ...
                        hover: {
                            onHover: function(a, t) {
                                if (t.length) {
                                    ...
                                    u('[data-canvas="' + n + '"] li:nth-child(' + o + ")").addClass("active")
                                } else
                                    u('[data-canvas="' + n + '"] li').removeClass("active")
                            }
                        }
        ...
        0 < t.length && t.each(function() {
            ...
            void 0 !== t && "" !== t) {
                ...
                a.each(function() {
                    ...
                    r.push(t),
                    i.push(o),
                    u(this).html('<span class="chart-c" style="background-color: ' + t + '"></span><span class="chart-l">' + a + '</span><span class="chart-p">' + o + "%</span>")
                }),
                ...
                console.log("Unable to draw canvas: " + t)
        }),
        0 < o.length && o.each(function() {
            ...
            void 0 !== t && "" !== t) {
                ...
                a.each(function() {
                    ...
                    d.push(e),
                    h.push(s),
                    u(this).html('<div class="chart-data-item"><span class="chart-label">' + t + '</span><span class="chart-info"><span class="chart-percent">' + s + '% </span><span class="chart-sublabel">' + o + "</span></span></div>")
                }),
        ...
        0 < n.length && n.each(function() {
            ...
            void 0 !== t && "" !== t) {
                ...
                a.each(function() {
                    ...
                    i.push(o),
                    l.push(n),
                    u(this).html('<span class="chart-l">' + a + '</span><span class="chart-p" style="background-color: ' + t + '" ><span>' + n + "%</span></span>")
                });
